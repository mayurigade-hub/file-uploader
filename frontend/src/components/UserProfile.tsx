...
import { User, Mail, Phone, Calendar, HardDrive, FileText, Loader2, Key, CheckCircle2, AlertCircle, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-gray-800">
              {!showPasswordForm ? (
                ...
                <form onSubmit={handlePasswordChange} className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  {passMessage.text && (
                    <div className={`p-3 rounded-xl text-xs font-bold flex items-center gap-2 ${passMessage.type === 'success' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'
                      }`}>
